...
if __name__ == "__main__":
    ...
    parser.add_argument("--merging_method_name", type=str, default="average_merging", help="name of the method to merge models",
                        choices=["average_merging", "task_arithmetic", "mask_merging","ada_task_arithmetic","emr_merging"])
    ...
    if args.merging_method_name == "average_merging" or args.merging_method_name == "emr_merging":
    ...
    elif args.merging_method_name == "ada_task_arithmetic":
    ...
    save_merge_log_path = f"/ibex/user/anb/save_merge_llm_logs/{'_'.join(merge_task_names)}/{args.save_model_name}"
