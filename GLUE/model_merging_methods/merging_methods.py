...
class MergingMethod:
    ...
    def merging_models(self, merged_model: nn.Module, models_to_merge: list, exclude_param_names_regex: list, trainers: list = None, scaling_coefficient: float = 1.0,
                       ...
                       mask_apply_method: str = "average_merging", models_use_deepcopy: bool = False, num_ada_examples: list = None):
        """
        ...
        if self.merging_method_name == "average_merging":
        ...
        elif self.merging_method_name == "ada_regmean_merging":
            merged_params = self.ada_regmean_merging(models_to_merge=models_to_merge, trainers=trainers, exclude_param_names_regex=exclude_param_names_regex,
                                                 nums_regmean_examples=nums_regmean_examples, reduce_non_diagonal_ratio=reduce_non_diagonal_ratio, model_name=model_name, rank_scale=rank_scale)
            ...
            if mask_apply_method == "average_merging":
                ...
                merged_params = self.regmean_merging(models_to_merge=new_models_to_merge, trainers=trainers, exclude_param_names_regex=exclude_param_names_regex,
                                                     nums_regmean_examples=nums_regmean_examples, reduce_non_diagonal_ratio=reduce_non_diagonal_ratio)
            elif mask_apply_method == "ada_regmean_merging":
                merged_params = self.ada_regmean_merging(models_to_merge=new_models_to_merge, trainers=trainers, exclude_param_names_regex=exclude_param_names_regex,
                                                     nums_regmean_examples=nums_regmean_examples, reduce_non_diagonal_ratio=reduce_non_diagonal_ratio, model_name=model_name, rank_scale=rank_scale)  
    ...
    def get_merged_model(self, merged_model: nn.Module, models_to_merge: list, exclude_param_names_regex: list, trainers: list = None, scaling_coefficient: float = 1.0,
        ...
        if mask_apply_method == "emr_merging":
    ...
    def pave_task_arithmetic(self, merged_model: nn.Module, models_to_merge: list, trainers: list = None, num_ada_examples: list = None,
        ...
        with torch.no_grad():
            ...
            merged_task_vector = models_to_merge_task_vectors[7]
